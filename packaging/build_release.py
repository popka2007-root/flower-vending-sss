...
def main() -> int:
    ...
    cmd = [
        ...
        "--add-data",
        f"src/flower_vending/ui/assets{os.pathsep}flower_vending/ui/assets",
        "--hidden-import",
        "flower_vending.devices.dbv300sd.protocol.jcm_serial",
        "--hidden-import",
        "flower_vending.devices.arduino",
        "--hidden-import",
        "flower_vending.devices.printer",
        "--hidden-import",
        "flower_vending.runtime.production",
        "--hidden-import",
        "flower_vending.runtime.discover",
        "--hidden-import",
        "serial",
        "--hidden-import",
